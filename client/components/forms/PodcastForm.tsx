  ...
  return (
    <div className="relative">
        ...
        {isSubmitting && (
            <div className="absolute inset-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md flex flex-col items-center justify-center rounded-xl animate-in fade-in duration-300">
                <div className="relative mb-3">
                    ...
                    <Mic className="absolute inset-0 m-auto text-blue-600 animate-pulse" size={16} />
                </div>
                <h3 className="text-lg font-bold text-slate-800 dark:text-white tracking-tight mb-2">Publishing Episode...</h3>
        ...
        <div className="space-y-3">
            <div className="pb-2 border-b border-slate-100 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-800 dark:text-white flex items-center">
                    <Mic className="mr-2 text-blue-500" size={14} /> Episode Information
                </h3>
        ...
        <div className="space-y-3">
            <div className="pb-2 border-b border-slate-100 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-800 dark:text-white flex items-center">
                    <UploadCloud className="mr-2 text-indigo-500" size={14} /> Media Assets
                </h3>
            ...
            <div>
                ...
                <div className="mt-1 flex justify-center px-3 pt-5 pb-3 border-2 border-slate-300 dark:border-slate-700 border-dashed rounded-xl hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors cursor-pointer group">
