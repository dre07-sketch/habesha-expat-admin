...
const AdForm: React.FC<AdFormProps> = ({ onSubmit, onCancel }) => {
    ...
    return (
        <div className="relative">
            ...
            {isSubmitting && (
                <div className="absolute inset-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md flex flex-col items-center justify-center rounded-xl animate-in fade-in duration-300">
                    <div className="relative mb-3">
                        ...
                        <Megaphone className="absolute inset-0 m-auto text-blue-600 animate-pulse" size={16} />
                    </div>
                    <h3 className="text-lg font-bold text-slate-800 dark:text-white tracking-tight mb-2">Launching Campaign...</h3>
            ...
            {/* Success Message */}
            {submitMessage && (
                <div className="mb-3 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
                <div className="pb-2 border-b border-slate-100 dark:border-slate-700">
                    <h3 className="text-lg font-bold text-slate-800 dark:text-white flex items-center">
                        <Megaphone className="mr-2 text-blue-500" size={14} /> Campaign Information
                    </h3>
